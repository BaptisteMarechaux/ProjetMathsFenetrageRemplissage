...
glm::vec2 intersection(const glm::vec2& checkedPointA, const glm::vec2& checkedPointB, const glm::vec2& windowPointA, const glm::vec2& windowPointB) {
	...
	*/
	...
	std::cout << "Point verified " << checkedPointA.x << ", " << checkedPointA.y << std::endl;
	std::cout << "Point verified " << checkedPointB.x << ", " << checkedPointB.y << std::endl;

	std::cout << "Win verified " << windowPointA.x << ", " << windowPointA.y << std::endl;
	std::cout << "Win verified " << windowPointB.x << ", " << windowPointB.y << std::endl;
	...
	finalRes = checkedPointA + (checkedPointB - checkedPointA)*res.x;
